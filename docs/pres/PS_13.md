...
## -0.79424 -0.35346 -0.09462  0.34267  1.15380 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)
## (Intercept) -0.19628    0.29455  -0.666    0.524
## runif(10)   -0.05514    0.59420  -0.093    0.928
## 
## Residual standard error: 0.6169 on 8 degrees of freedom
## Multiple R-squared:  0.001075,	Adjusted R-squared:  -0.1238 
## F-statistic: 0.00861 on 1 and 8 DF,  p-value: 0.9284
```
...
|:-----------|--------:|---------:|---------:|-------:|
|(Intercept) |    -0.51|      0.48|     -1.06|    0.32|
|runif(10)   |     0.57|      0.76|      0.75|    0.47|
