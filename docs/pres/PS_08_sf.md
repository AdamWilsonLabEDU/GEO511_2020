...
```
##           [,1]      [,2]
## [1,] 0.1829950 0.8892457
## [2,] 0.9439781 0.3729566
## [3,] 0.1949058 0.4411707
```
...
```
## LINESTRING (0.182995 0.8892457, 0.9439781 0.3729566, 0.1949058 0.4411707)
```
...
## dimension:      XY
## bbox:           xmin: 0.182995 ymin: 0.3729566 xmax: 0.9439781 ymax: 0.8892457
## epsg (SRID):    NA
## proj4string:    NA
```

```
## LINESTRING (0.182995 0.8892457, 0.9439781 0.372...
```
...
## proj4string:    NA
##     type                      lnstr_sfc
## 1 random LINESTRING (0.182995 0.8892...
```
...
|type   |lnstr_sfc                                                                                                          |
|:------|:------------------------------------------------------------------------------------------------------------------|
|random |c(0.182994956849143, 0.943978057708591, 0.19490582216531, 0.889245748985559, 0.372956614941359, 0.441170674050227) |
...
```
## [1] "/Library/Frameworks/R.framework/Versions/3.6/Resources/library/spData/shapes/world.gpkg"
```
...
```
## Reading layer `world' from data source `/Library/Frameworks/R.framework/Versions/3.6/Resources/library/spData/shapes/world.gpkg' using driver `GPKG'
...
![](PS_08_sf_files/figure-revealjs/unnamed-chunk-22-1.png)
...
![](PS_08_sf_files/figure-revealjs/unnamed-chunk-27-1.png)
