...
![](PS_04_files/figure-revealjs/unnamed-chunk-2-1.png)
...
##   ..@ coords: num [1:3, 1:2] 0.6367 0.2052 0.0339 0.5075 0.4201 ...
```
...
```
##            [,1]      [,2]
## [1,] 0.63668081 0.5074808
## [2,] 0.20519707 0.4200808
## [3,] 0.03389065 0.7154050
```
...
##   .. .. .. .. .. .. ..@ coords: num [1:3, 1:2] 0.6367 0.2052 0.0339 0.5075 0.4201 ...
##   .. .. .. ..@ ID   : chr "a"
##   ..@ bbox       : num [1:2, 1:2] 0.0339 0.4201 0.6367 0.7154
...
## dimension:      XY
## bbox:           xmin: 0.2429504 ymin: 0.3763719 xmax: 0.7998404 ymax: 0.827356
## epsg (SRID):    NA
## proj4string:    NA
```

```
## LINESTRING (0.6789398 0.6839036, 0.7998404 0.82...
```
...
## 1  a road            10 LINESTRING (0.6789398 0.683...
```
...
## 6               Cyprus    1152309  0.7327776  6207.006   185.64650
## 7              Vanuatu     258850  2.2298147  7490.040    34.55923
## 8  Trinidad and Tobago    1354493  0.4621243  7737.810   175.04863
## 9          Puerto Rico    3534874 -1.6331283  9224.663   383.19817
## 10             Lebanon    5603279  6.0164395 10099.003   554.83487
##                              geom
## 1  MULTIPOLYGON (((6.043073 50...
## 2  MULTIPOLYGON (((32.73178 35...
## 3  MULTIPOLYGON (((32.73178 35...
## 4  MULTIPOLYGON (((32.73178 35...
## 5  MULTIPOLYGON (((35.39756 31...
## 6  MULTIPOLYGON (((32.73178 35...
## 7  MULTIPOLYGON (((167.2168 -1...
...
![](PS_04_files/figure-revealjs/unnamed-chunk-26-1.png)![](PS_04_files/figure-revealjs/unnamed-chunk-26-2.png)
...
![](PS_04_files/figure-revealjs/unnamed-chunk-27-1.png)
...
![](PS_04_files/figure-revealjs/unnamed-chunk-28-1.png)
...
![](PS_04_files/figure-revealjs/unnamed-chunk-29-1.png)
...
![](PS_04_files/figure-revealjs/unnamed-chunk-30-1.png)
...
```
## Warning in tm_style_grey(): tm_style_grey is deprecated as of tmap version
## 2.0. Please use tm_style("grey", ...) instead
```
...
<img src="PS_04_files/figure-revealjs/unnamed-chunk-31-1.png" style="display: block; margin: auto;" />
